...
class CvsOrderAppendRequest
{
    ...
    protected $payer_postcode;

    protected $payer_address;
    protected $payer_mobile;
    protected $payer_email;
    protected $payment_type;
    protected $payment_acquirerType = 0;
    protected $apn_url;
    protected $order_detail;

    protected $b2c;
    protected $product_name;
    protected $print_invoice;
    protected $vehicle_type;
    protected $vehicle_barcode;
    protected $donate_invoice;
    protected $love_code;
    protected $buyer_bill_no;
    protected $buyer_invoice_title;
    protected $buyer_invoice_zip;
    protected $buyer_invoice_addr;
